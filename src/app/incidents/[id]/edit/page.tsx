...
export default function EditIncidentPage() {
      ...
      <div>
        <PageHeader
          ...
          breadcrumbs={[
            ...
            { label: 'Details', href: `/incidents/${incidentId}` },
            { label: 'Edit' }
          ]}
        />
      ...
      <div>
        ...
        <div className="text-center py-12">
          ...
          <p className="mt-1 text-sm text-gray-500">
            The incident you're trying to edit doesn't exist or has been deleted.
          </p>
        </div>
      </div>
    )
  ...
  return (
    <div>
      <PageHeader
        title="Edit Incident"
        description="Update the details of your allergy incident"
        breadcrumbs={[
          { label: 'Dashboard', href: '/dashboard' },
          { label: 'Incidents', href: '/incidents' },
          { label: 'Details', href: `/incidents/${incidentId}` },
