      ...
      if (hasRealSupabase) {
        ...
        if (result.user) {
          showToast({
            ...
            description: 'Welcome to Allergy Tracker. Please check your email to verify your account.'
          })
          router.push('/dashboard')
        }
      } else {
        // Demo/development mode - simulate account creation
        await new Promise(resolve => setTimeout(resolve, 1500))
        
        showToast({
          type: 'success',
          title: 'Account created!',
          description: 'Welcome to Allergy Tracker. You can now start tracking your incidents.'
        })
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Start tracking your allergy incidents today
          </p>
        </div>
